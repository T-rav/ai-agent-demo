...
from ..models import ProcessedDocument, DocumentChunk, ChunkingError, ChunkMetadata, FileType
from ..utils import TiktokenEncoder, ParagraphSplitter, SentenceSplitter, MarkdownSectionSplitter
...
class PDFChunkingStrategy(ChunkingStrategy):
    ...
    def chunk(self, document: ProcessedDocument, chunker: 'DocumentChunkingService') -> List[DocumentChunk]:
        ...
        for i, page_content in enumerate(pages):
            ...
            page_chunks = chunker._chunk_text_content(
                document, page_content, page_num=i if i > 0 else None
            )
