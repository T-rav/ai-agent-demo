...
class SmartTextChunker:
    ...
    def _chunk_text_content(self, document: Dict[str, Any], content: str, 
                           section_header: str = None, page_num: int = None) -> List[Dict[str, Any]]:
                ...
                for sentence in sentences:
                    ...
                    if current_tokens + sentence_tokens > self.chunk_size and current_chunk:
                        ...
                        chunks.append(self._create_chunk(
                            ...
                            section_header=section_header, page_num=page_num
                        ))
    ...
    def _split_into_sentences(self, text: str) -> List[str]:
        ...
        text = re.sub(r'\b(?:Dr|Mr|Mrs|Ms|Prof|Sr|Jr|vs|etc|i\.e|e\.g)\.\s*', lambda m: m.group().replace('.', '<!DOT!>'), text)
    ...
    def _create_chunk(self, document: Dict[str, Any], chunk_text: str, chunk_index: int, 
                     section_header: str = None, page_num: int = None) -> Dict[str, Any]:
