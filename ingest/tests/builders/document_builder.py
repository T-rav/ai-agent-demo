...
class ProcessedDocumentBuilder:
    ...
    def with_long_content(self) -> 'ProcessedDocumentBuilder':
        ...
        long_content = " ".join([f"This is sentence {i} in a long document." for i in range(100)])
    ...
    def with_empty_content(self) -> 'ProcessedDocumentBuilder':
        """Set empty content."""
        return self.with_content("Empty document content").with_token_count(3).with_char_count(20)  # Pydantic requires non-empty string
