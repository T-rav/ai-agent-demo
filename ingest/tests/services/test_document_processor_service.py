...
from ...models import ProcessedDocument, FileType, ProcessingError
...
class TestDocumentProcessorService:
    ...
    def test_process_file_content_extraction_error(self, service, mock_file_path):
        ...
        with patch.object(service._content_extractor, 'extract_content', side_effect=ProcessingError("Extraction failed")):
