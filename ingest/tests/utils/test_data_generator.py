...
class TestDataGenerator:
    ...
    def generate_markdown_sections(num_sections: int = 3) -> str:
        ...
        for i in range(num_sections):
            ...
            sections.append(f"This is the content for section {i + 1}.")
    ...
    def generate_pdf_pages(num_pages: int = 2) -> str:
        ...
        for i in range(num_pages):
            ...
            pages.append(f"Content for page {i + 1} of the document.")
    ...
    def generate_long_text(num_sentences: int = 50) -> str:
        ...
        sentences = [f"This is sentence number {i + 1} in a long document." for i in range(num_sentences)]
    ...
    def generate_chunk_list(num_chunks: int = 3, document_title: str = "Test Document") -> List:
        ...
        for i in range(num_chunks):
            chunk = (a_document_chunk()
                    .with_id(f"chunk-{i}")
                    .with_chunk_index(i)
                    .with_document_title(document_title)
                    .with_content(f"Content for chunk {i}")
                    .build())
            chunks.append(chunk)
        return chunks
